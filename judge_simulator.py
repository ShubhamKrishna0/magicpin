...
# Your API key — auto-loaded from .env file if available
def _read_env_key(key, default=""):
    """Read a key from .env file if not already set."""
    import os
...
LLM_API_KEY = _read_env_key("LLM_API_KEY")
LLM_MODEL = _read_env_key("LLM_MODEL")
